...
{{ include "mysql-backup.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mysql-backup.selectorLabels" -}}
...
*/}}
{{- define "mysql-backup.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "mysql-backup.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
